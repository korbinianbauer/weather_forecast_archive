...
def _init_default_settings(conn):
    defaults = {
        'poll_cron':        '0 6 * * *',
'provider_colors': json.dumps({'wetter_com': '#3b82f6', 'meteoblue': '#22c55e', 'wetteronline': '#f97316', 'dwd': '#dc2626', 'lwd_bayern': '#0d9488', 'lwd_tirol': '#9333ea', 'hd_tirol': '#ca8a04', 'average': '#111827'}),
        'provider_delays':  json.dumps({'wetter_com': 0.25, 'meteoblue': 0.25, 'wetteronline': 0.25, 'dwd': 0.25, 'lwd_bayern': 0.25, 'lwd_tirol': 0.25, 'hd_tirol': 0.25}),
    }
